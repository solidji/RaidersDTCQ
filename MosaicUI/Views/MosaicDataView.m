...
-(void)setModule:(MosaicData *)newModule{
    ...
    if ([self.module.imageFilename isEqualToString:@"Forum-blue.png"] || [self.module.imageFilename isEqualToString:@"video-blue.png"]) {
        UIImage *anImage = [UIImage imageNamed:self.module.imageFilename];
        imageView.image = anImage;
    }else {
        [imageView setImageWithURL:[NSURL URLWithString:self.module.imageFilename]
    ...
    if (imageView.image.size.width < imageView.image.size.height){
        ...
        imgFinalSize.height = self.bounds.size.width * imageView.image.size.height / imageView.image.size.width;
        ...
        imgFinalSize.height = self.bounds.size.height;
        imgFinalSize.width = self.bounds.size.height * imageView.image.size.width / imageView.image.size.height;
