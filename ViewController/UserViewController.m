...
- (id)initWithTitle:(NSString *)title withUser:(IADisqusUser *)user withRevealBlock:(UserRevealBlock)revealBlock {
...
- (void)viewDidLoad
{
    ...
    start = 0;
    receiveMember = 0;
    avatarImage=[[UIImageView alloc] initWithFrame:CGRectMake(8, 96-36-30, 36, 36)];
    ...
    [avatarImage.layer setBorderWidth: 1.0];
    [avatarImage.layer setCornerRadius:18.0];
    ...
    pullToRefreshTableView.tag = 100000;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    UserItemCell *cell = (UserItemCell*) [tableView dequeueReusableCellWithIdentifier:CellIdentifier];
    if (cell == nil) {
